...
import { Notebook, Mail, Lock, User, Loader, Image } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register(email, password, name, profilePicture); // Pass the file directly
      navigate('/app');
    } catch (err) {
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-2xl font-playfair text-gray-800">Create Account</h1>
          </div>
